...
class ConsignmentController extends GenericController
{
    public function __construct()
    {
        parent::__construct();
        require_once __DIR__ . "/../model/ConsignmentModel.php";
    }
    ...
    public function edit()
    {
        ...
        if (isset($id)) {
            $customer = new ConsignmentModel($this->connection);
            $result = $customer->getcustomerbyid($id);            
        }
        echo $this->twig->render('customer-management/consignment/edit.html', array(
            "logindetails" => $_SESSION['logindetails'],
            "breadcrumb" => $this->breadcrumb,
            "result" => $result
        ));
    ...
    {        
        ...
        if($type == "receiver"){
            ...
            $data = array(
                ...
                "province" => $details[12]->value,
                "city" => $details[13]->value,
                "barangay" => $details[14]->value,
                "postal_code" => $details[15]->value,
                "house_number_street" => $details[16]->value,                
